...
export const BoardPage = () => {
  ...
  const handleStatsChange = useCallback(
    (updatedStats: { totalPaintable: number; paintedCount: number; remaining: number }, clearGrid: () => void) => {
  ...
  if (!playerId) return <div className="flex items-center justify-center min-h-screen text-white"><p>No se encontró el usuario.</p></div>;
  if (loading) return <div className="flex items-center justify-center min-h-screen text-white"><p>Cargando tablero...</p></div>;
  if (!boardData) return <div className="flex items-center justify-center min-h-screen text-white"><p>Error al cargar el tablero o no existe.</p></div>;
